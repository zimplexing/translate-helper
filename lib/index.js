...
var translateText_1 = require("./src/translateText");
exports.run = function (language, publicDir) {
    if (language === void 0) { language = 'en_US'; }
    if (publicDir === void 0) { publicDir = '/static/'; }
    var jsonPath = path.resolve(process.cwd(), "." + publicDir + "i18n/zh_CN/index.json");
    var pathExists = fs.pathExists(jsonPath);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            console.info('开始翻译...');
                            return [4 /*yield*/, translateText_1.default(doc, language)];
                        case 1:
